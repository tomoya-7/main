...
request1.open('GET', '../audio/harugakita_s.mp3', true);
...
request2.open('GET', '../audio/harugakita_a.mp3', true);
...
request3.open('GET', '../audio/harugakita_t.mp3', true);
...
request4.open('GET', '../audio/harugakita_p.mp3', true);
