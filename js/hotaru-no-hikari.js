...
request1.open('GET', '../audio/hotaru-no-hikari_s.mp3', true);
...
request2.open('GET', '../audio/hotaru-no-hikari_a.mp3', true);
...
request3.open('GET', '../audio/hotaru-no-hikari_t.mp3', true);
...
request4.open('GET', '../audio/hotaru-no-hikari_p.mp3', true);
