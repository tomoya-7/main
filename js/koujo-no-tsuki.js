...
request1.open('GET', '../audio/koujo-no-tsuki_s.mp3', true);
...
request2.open('GET', '../audio/koujo-no-tsuki_a.mp3', true);
...
request3.open('GET', '../audio/koujo-no-tsuki_t.mp3', true);
...
request4.open('GET', '../audio/koujo-no-tsuki_p.mp3', true);
