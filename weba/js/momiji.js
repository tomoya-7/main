...
request1.open('GET', '../audio/momiji_s.mp3', true);
...
request2.open('GET', '../audio/momiji_a.mp3', true);
...
request3.open('GET', '../audio/momiji_t.mp3', true);
...
request4.open('GET', '../audio/momiji_p.mp3', true);
